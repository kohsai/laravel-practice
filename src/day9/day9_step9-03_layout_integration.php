...
/**
 * 📘 Day9 教材（Step9-03：expenses系ビューをレイアウトに統合する）
 *
 ...
 *
 * 意味：
 * 「このファイルは layouts/app.blade.php という틀（わく）を使います」
 *
 * セットで使う記法：
 *
 ...
 *
 * ※ x-alert コンポーネントが「errorタイプ」に対応している前提です。
 *   Step9-02で作ったalert.blade.phpの内容を確認してください（後述）。
 */
...
/**
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 * ⚠️ 【4. alert.blade.phpのerror対応確認】
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * create・editで <x-alert type="error" :errors="$errors" /> を使うには、
 * components/alert.blade.php が「errorタイプ」に対応している必要があります。
 *
 * 現在の alert.blade.php の中身を確認して、以下を教えてください：
 * 「errorタイプの処理が書かれていますか？」
 *
 * もし書かれていない場合は、このStep内でalert.blade.phpも修正します。
 * 書かれている場合はそのまま進めます。
 *
 * 【alert.blade.phpの確認方法】
 * VSCodeで resources/views/components/alert.blade.php を開いて内容を見る
 */
 ...
 *     "error" なら赤い枠・文字でエラーメッセージを表示する設計にします。
